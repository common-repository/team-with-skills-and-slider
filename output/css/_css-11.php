<style type="text/css">
  ...
  .twss_6310_team_style_<?php echo $ids; ?>_img_border {
    position: relative;
    padding: 10px 0 10px 20px;
  }

  .twss_6310_team_style_<?php echo $ids; ?>_img_border:before {
    content: "";
    width: 40px;
    height: 100%;
    position: absolute;
  ...
  .twss_6310_team_style_<?php echo $ids; ?>:hover .twss_6310_team_style_<?php echo $ids; ?>_img_border:before {
    background: <?php echo $cssData['image_hover_background'] ?>;
  }
  ...
  .twss_6310_team_style_<?php echo $ids; ?>_caption:before {
    content: "";
    width: 100%;
    height: 100%;
    position: absolute;
  ...
  .twss_6310_team_style_<?php echo $ids; ?>:hover .twss_6310_team_style_<?php echo $ids; ?>_caption:before {
    left: 0;
  }
