<style type="text/css">
  ...
  .twss-6310-owl-stage .twss-6310-owl-item:nth-child(1) .twss-6310-item .twss_6310_team_style_<?php echo $ids; ?>,
  .twss-6310-owl-stage .twss-6310-owl-item:nth-child(6) .twss-6310-item .twss_6310_team_style_<?php echo $ids; ?>,
  .twss-6310-owl-stage .twss-6310-owl-item:nth-child(11) .twss-6310-item .twss_6310_team_style_<?php echo $ids; ?>,
  .twss-6310-owl-stage .twss-6310-owl-item:nth-child(16) .twss-6310-item .twss_6310_team_style_<?php echo $ids; ?> {
    background: <?php echo $cssData['box_background_first_color'] ?> !important;
  ...
  .twss-6310-owl-stage .twss-6310-owl-item:nth-child(2) .twss-6310-item .twss_6310_team_style_<?php echo $ids; ?>,
  .twss-6310-owl-stage .twss-6310-owl-item:nth-child(7) .twss-6310-item .twss_6310_team_style_<?php echo $ids; ?>,
  .twss-6310-owl-stage .twss-6310-owl-item:nth-child(12) .twss-6310-item .twss_6310_team_style_<?php echo $ids; ?>,
  .twss-6310-owl-stage .twss-6310-owl-item:nth-child(17) .twss-6310-item .twss_6310_team_style_<?php echo $ids; ?> {
    background: <?php echo $cssData['box_background_second_color'] ?> !important;
  ...
  .twss-6310-owl-stage .twss-6310-owl-item:nth-child(3) .twss-6310-item .twss_6310_team_style_<?php echo $ids; ?>,
  .twss-6310-owl-stage .twss-6310-owl-item:nth-child(8) .twss-6310-item .twss_6310_team_style_<?php echo $ids; ?>,
  .twss-6310-owl-stage .twss-6310-owl-item:nth-child(13) .twss-6310-item .twss_6310_team_style_<?php echo $ids; ?>,
  .twss-6310-owl-stage .twss-6310-owl-item:nth-child(18) .twss-6310-item .twss_6310_team_style_<?php echo $ids; ?> {
    background: <?php echo $cssData['box_background_third_color'] ?> !important;
  ...
  .twss-6310-owl-stage .twss-6310-owl-item:nth-child(4) .twss-6310-item .twss_6310_team_style_<?php echo $ids; ?>,
  .twss-6310-owl-stage .twss-6310-owl-item:nth-child(9) .twss-6310-item .twss_6310_team_style_<?php echo $ids; ?>,
  .twss-6310-owl-stage .twss-6310-owl-item:nth-child(14) .twss-6310-item .twss_6310_team_style_<?php echo $ids; ?>,
  .twss-6310-owl-stage .twss-6310-owl-item:nth-child(19) .twss-6310-item .twss_6310_team_style_<?php echo $ids; ?> {
    background: <?php echo $cssData['box_background_fourth_color'] ?> !important;
  ...
  .twss-6310-owl-stage .twss-6310-owl-item:nth-child(5) .twss-6310-item .twss_6310_team_style_<?php echo $ids; ?>,
  .twss-6310-owl-stage .twss-6310-owl-item:nth-child(10) .twss-6310-item .twss_6310_team_style_<?php echo $ids; ?>,
  .twss-6310-owl-stage .twss-6310-owl-item:nth-child(15) .twss-6310-item .twss_6310_team_style_<?php echo $ids; ?>,
  .twss-6310-owl-stage .twss-6310-owl-item:nth-child(20) .twss-6310-item .twss_6310_team_style_<?php echo $ids; ?> {
    background: <?php echo $cssData['box_background_five_color'] ?> !important;
  }
  ...
  .twss-6310-owl-stage .twss-6310-owl-item:nth-child(6) .twss-6310-item .twss_6310_team_style_<?php echo $ids; ?> {
    background: <?php echo $cssData['box_background_six_color'] ?> !important;
  }
  .twss-6310-row div.twss-6310-col-<?php echo $cssData['item_per_row'] ?>:nth-child(1):hover,
  .twss-6310-category-filter-row div.twss-6310-col-<?php echo $cssData['item_per_row'] ?>:nth-child(1):hover .twss-6310-owl-stage .twss-6310-owl-item:nth-child(1):hover .twss-6310-item .twss_6310_team_style_<?php echo $ids; ?>,
  .twss-6310-owl-stage .twss-6310-owl-item:nth-child(6):hover .twss-6310-item .twss_6310_team_style_<?php echo $ids; ?>,
  .twss-6310-owl-stage .twss-6310-owl-item:nth-child(11):hover .twss-6310-item .twss_6310_team_style_<?php echo $ids; ?>,
  .twss-6310-owl-stage .twss-6310-owl-item:nth-child(16):hover .twss-6310-item .twss_6310_team_style_<?php echo $ids; ?> {
    background: <?php echo $cssData['box_background_first_hover_color'] ?> !important;

  }
  .twss-6310-row div.twss-6310-col-<?php echo $cssData['item_per_row'] ?>:nth-child(2):hover,
  .twss-6310-category-filter-row div.twss-6310-col-<?php echo $cssData['item_per_row'] ?>:nth-child(2):hover .twss-6310-owl-stage .twss-6310-owl-item:nth-child(2):hover .twss-6310-item .twss_6310_team_style_<?php echo $ids; ?>,
  .twss-6310-owl-stage .twss-6310-owl-item:nth-child(7):hover .twss-6310-item .twss_6310_team_style_<?php echo $ids; ?>,
  .twss-6310-owl-stage .twss-6310-owl-item:nth-child(12):hover .twss-6310-item .twss_6310_team_style_<?php echo $ids; ?>,
  .twss-6310-owl-stage .twss-6310-owl-item:nth-child(17):hover .twss-6310-item .twss_6310_team_style_<?php echo $ids; ?> {
    background: <?php echo $cssData['box_background_second_hover_color'] ?> !important;
  }
  .twss-6310-row div.twss-6310-col-<?php echo $cssData['item_per_row'] ?>:nth-child(3):hover,
  .twss-6310-category-filter-row div.twss-6310-col-<?php echo $cssData['item_per_row'] ?>:nth-child(3):hover .twss-6310-owl-stage .twss-6310-owl-item:nth-child(3):hover .twss-6310-item .twss_6310_team_style_<?php echo $ids; ?>,
  .twss-6310-owl-stage .twss-6310-owl-item:nth-child(8):hover .twss-6310-item .twss_6310_team_style_<?php echo $ids; ?>,
  .twss-6310-owl-stage .twss-6310-owl-item:nth-child(13):hover .twss-6310-item .twss_6310_team_style_<?php echo $ids; ?>,
  .twss-6310-owl-stage .twss-6310-owl-item:nth-child(18):hover .twss-6310-item .twss_6310_team_style_<?php echo $ids; ?> {
    background: <?php echo $cssData['box_background_third_hover_color'] ?> !important;
  }
  .twss-6310-row div.twss-6310-col-<?php echo $cssData['item_per_row'] ?>:nth-child(4):hover,
  .twss-6310-category-filter-row div.twss-6310-col-<?php echo $cssData['item_per_row'] ?>:nth-child(4):hover .twss-6310-owl-stage .twss-6310-owl-item:nth-child(4):hover .twss-6310-item .twss_6310_team_style_<?php echo $ids; ?>,
  .twss-6310-owl-stage .twss-6310-owl-item:nth-child(9):hover .twss-6310-item .twss_6310_team_style_<?php echo $ids; ?>,
  .twss-6310-owl-stage .twss-6310-owl-item:nth-child(14):hover .twss-6310-item .twss_6310_team_style_<?php echo $ids; ?>,
  .twss-6310-owl-stage .twss-6310-owl-item:nth-child(19):hover .twss-6310-item .twss_6310_team_style_<?php echo $ids; ?> {
    background: <?php echo $cssData['box_background_fourth_hover_color'] ?> !important;

  }
  .twss-6310-row div.twss-6310-col-<?php echo $cssData['item_per_row'] ?>:nth-child(5):hover,
  .twss-6310-category-filter-row div.twss-6310-col-<?php echo $cssData['item_per_row'] ?>:nth-child(5):hover .twss-6310-owl-stage .twss-6310-owl-item:nth-child(5):hover .twss-6310-item .twss_6310_team_style_<?php echo $ids; ?>,
  .twss-6310-owl-stage .twss-6310-owl-item:nth-child(10):hover .twss-6310-item .twss_6310_team_style_<?php echo $ids; ?>,
  .twss-6310-owl-stage .twss-6310-owl-item:nth-child(15):hover .twss-6310-item .twss_6310_team_style_<?php echo $ids; ?>,
  .twss-6310-owl-stage .twss-6310-owl-item:nth-child(20):hover .twss-6310-item .twss_6310_team_style_<?php echo $ids; ?> {
    background: <?php echo $cssData['box_background_five_hover_color'] ?> !important;
  }
  ...
  .twss-6310-category-filter-row div.twss-6310-col-<?php echo $cssData['item_per_row'] ?>:nth-child(6):hover {
    background: <?php echo $cssData['box_background_six_hover_color'] ?> !important;
  ...
  .twss_6310_team_style_<?php echo $ids; ?>_img img {
    border-color: <?php echo $cssData['box_img_background_color'] ?>;
    border-style: solid;
    border-width: <?php echo $cssData['box_img_border_width'] ?>px;
    border-radius: 50%;
  ...
  .twss_6310_team_style_<?php echo $ids; ?>_title {
    position: relative;
    background-color: <?php echo $cssData['member_bg_color'] ?>;
  ...
  .twss_6310_team_style_<?php echo $ids; ?>_designation {
    ...
    overflow: hidden;
    opacity: 1;
    background-color: <?php echo $cssData['designation_bg_color'] ?>;
