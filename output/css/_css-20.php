<style type="text/css">
  ...
  .twss_6310_team_style_<?php echo $ids; ?>.twss_6310_image_hover_effect {
    position: relative;
}
  ...
  .twss-6310-row div:nth-child(1) div div.twss_6310_team_style_<?php echo $ids; ?>_title,
  .twss-6310-category-filter-row div:nth-child(1) div div.twss_6310_team_style_<?php echo $ids; ?>_title,
  .twss-6310-owl-stage div:nth-child(1n+<?php echo $cssData['item_per_row'] ?>) div div.twss_6310_team_style_<?php echo $ids; ?>_title {
    background-color: <?php echo $cssData['box_background_first_color'] ?>;
  }

  .twss-6310-row div:nth-child(2) div div.twss_6310_team_style_<?php echo $ids; ?>_title,
  .twss-6310-category-filter-row div:nth-child(2) div div.twss_6310_team_style_<?php echo $ids; ?>_title,
  .twss-6310-owl-stage div:nth-child(2n+<?php echo $cssData['item_per_row'] ?>) div div.twss_6310_team_style_<?php echo $ids; ?>_title {
    background-color: <?php echo $cssData['box_background_second_color'] ?>;
  }

  .twss-6310-row div:nth-child(3) div div.twss_6310_team_style_<?php echo $ids; ?>_title,
  .twss-6310-category-filter-row div:nth-child(3) div div.twss_6310_team_style_<?php echo $ids; ?>_title,
  .twss-6310-owl-stage div:nth-child(3n+<?php echo $cssData['item_per_row'] ?>) div div.twss_6310_team_style_<?php echo $ids; ?>_title {
    background-color: <?php echo $cssData['box_background_third_color'] ?>;
  }

  .twss-6310-row div:nth-child(4) div div.twss_6310_team_style_<?php echo $ids; ?>_title,
  .twss-6310-category-filter-row div:nth-child(4) div div.twss_6310_team_style_<?php echo $ids; ?>_title,
  .twss-6310-owl-stage div:nth-child(4n+<?php echo $cssData['item_per_row'] ?>) div div.twss_6310_team_style_<?php echo $ids; ?>_title {
    background-color: <?php echo $cssData['box_background_fourth_color'] ?>;
  }

  .twss-6310-row div:nth-child(5) div div.twss_6310_team_style_<?php echo $ids; ?>_title,
  .twss-6310-category-filter-row div:nth-child(5) div div.twss_6310_team_style_<?php echo $ids; ?>_title,
  .twss-6310-owl-stage div:nth-child(5n+<?php echo $cssData['item_per_row'] ?>) div div.twss_6310_team_style_<?php echo $ids; ?>_title {
    background-color: <?php echo $cssData['box_background_five_color'] ?>;
  }

  .twss-6310-row div:nth-child(6) div div.twss_6310_team_style_<?php echo $ids; ?>_title,
  .twss-6310-category-filter-row div:nth-child(6) div div.twss_6310_team_style_<?php echo $ids; ?>_title,
  .twss-6310-owl-stage div:nth-child(6n+<?php echo $cssData['item_per_row'] ?>) div div.twss_6310_team_style_<?php echo $ids; ?>_title {
    background-color: <?php echo $cssData['box_background_six_color'] ?>;
  }

  .twss-6310-row div:nth-child(1) div:hover div.twss_6310_team_style_<?php echo $ids; ?>_title,
  .twss-6310-category-filter-row div:nth-child(1) div:hover div.twss_6310_team_style_<?php echo $ids; ?>_title,
  .twss-6310-owl-stage div:nth-child(1n+<?php echo $cssData['item_per_row'] ?>) div:hover div.twss_6310_team_style_<?php echo $ids; ?>_title {
    background-color: <?php echo $cssData['box_background_first_hover_color'] ?>;
  }

  .twss-6310-row div:nth-child(2) div:hover div.twss_6310_team_style_<?php echo $ids; ?>_title,
  .twss-6310-category-filter-row div:nth-child(2) div:hover div.twss_6310_team_style_<?php echo $ids; ?>_title,
  .twss-6310-owl-stage div:nth-child(2n+<?php echo $cssData['item_per_row'] ?>) div:hover div.twss_6310_team_style_<?php echo $ids; ?>_title {
    background-color: <?php echo $cssData['box_background_second_hover_color'] ?>;
  }

  .twss-6310-row div:nth-child(3) div:hover div.twss_6310_team_style_<?php echo $ids; ?>_title,
  .twss-6310-category-filter-row div:nth-child(3) div:hover div.twss_6310_team_style_<?php echo $ids; ?>_title,
  .twss-6310-owl-stage div:nth-child(3n+<?php echo $cssData['item_per_row'] ?>) div:hover div.twss_6310_team_style_<?php echo $ids; ?>_title {
    background-color: <?php echo $cssData['box_background_third_hover_color'] ?>;
  }

  .twss-6310-row div:nth-child(4) div:hover div.twss_6310_team_style_<?php echo $ids; ?>_title,
  .twss-6310-category-filter-row div:nth-child(4) div:hover div.twss_6310_team_style_<?php echo $ids; ?>_title,
  .twss-6310-owl-stage div:nth-child(4n+<?php echo $cssData['item_per_row'] ?>) div:hover div.twss_6310_team_style_<?php echo $ids; ?>_title {
    background-color: <?php echo $cssData['box_background_fourth_hover_color'] ?>;
  }

  .twss-6310-row div:nth-child(5) div:hover div.twss_6310_team_style_<?php echo $ids; ?>_title,
  .twss-6310-category-filter-row div:nth-child(5) div:hover div.twss_6310_team_style_<?php echo $ids; ?>_title,
  .twss-6310-owl-stage div:nth-child(5n+<?php echo $cssData['item_per_row'] ?>) div:hover div.twss_6310_team_style_<?php echo $ids; ?>_title {
    background-color: <?php echo $cssData['box_background_five_hover_color'] ?>;
  }

  .twss-6310-row div:nth-child(6) div:hover div.twss_6310_team_style_<?php echo $ids; ?>_title,
  .twss-6310-category-filter-row div:nth-child(6) div:hover div.twss_6310_team_style_<?php echo $ids; ?>_title,
  .twss-6310-owl-stage div:nth-child(6n+<?php echo $cssData['item_per_row'] ?>) div:hover div.twss_6310_team_style_<?php echo $ids; ?>_title {
