...
.twss_6310_team_style_<?php echo $ids; ?>:hover {
  ...
  {
     background: linear-gradient(to right, <?php echo $cssData['box_background_first_color'] ?>, <?php echo $cssData['box_background_first_hover_color'] ?> );
  }
  ...
  {
     background: linear-gradient(to right, <?php echo $cssData['box_background_second_color'] ?>, <?php echo $cssData['box_background_second_hover_color'] ?> );
  }
  ...
  {
     background: linear-gradient(to right, <?php echo $cssData['box_background_third_color'] ?>, <?php echo $cssData['box_background_third_hover_color'] ?> );
  }
  ...
  {
     background: linear-gradient(to right, <?php echo $cssData['box_background_fourth_color'] ?>, <?php echo $cssData['box_background_fourth_hover_color'] ?> );
  }
  ...
  {
     background: linear-gradient(to right, <?php echo $cssData['box_background_five_color'] ?>, <?php echo $cssData['box_background_five_hover_color'] ?> );
  }
  ...
  {
     background: linear-gradient(to right, <?php echo $cssData['box_background_six_color'] ?>, <?php echo $cssData['box_background_six_hover_color'] ?> );
  }
  ...
  {
     background: linear-gradient(to right,  <?php echo $cssData['box_background_first_hover_color'] ?>, <?php echo $cssData['box_background_first_color'] ?> );
  }
  ...
  {
     background: linear-gradient(to right,  <?php echo $cssData['box_background_second_hover_color'] ?>,<?php echo $cssData['box_background_second_color'] ?> );
  }
  ...
  {
     background: linear-gradient(to right,  <?php echo $cssData['box_background_third_hover_color'] ?> ,<?php echo $cssData['box_background_third_color'] ?>);
  }
  ...
  {
     background: linear-gradient(to right,  <?php echo $cssData['box_background_fourth_hover_color'] ?>, <?php echo $cssData['box_background_fourth_color'] ?> );
  }
  ...
  {
     background: linear-gradient(to right,  <?php echo $cssData['box_background_five_hover_color'] ?>,<?php echo $cssData['box_background_five_color'] ?> );
  }
  .twss-6310-category-filter-row div.twss-6310-col-<?php echo $cssData['item_per_row'] ?>:nth-child(6),
  .twss-6310-row div.twss-6310-col-<?php echo $cssData['item_per_row'] ?>:nth-child(6),
  .twss-6310-owl-stage .twss-6310-owl-item:nth-child(6n+<?php echo $cssData['item_per_row'] ?>) .twss-6310-item .twss_6310_team_style_<?php echo $ids; ?>
  {
     background: linear-gradient(to right,  <?php echo $cssData['box_background_six_hover_color'] ?>, <?php echo $cssData['box_background_six_color'] ?> );
  }
