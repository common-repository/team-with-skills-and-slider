<style type="text/css">
  ...
  .twss_6310_team_style_01:hover img.twss_hover_image {
    display: initial !important;
  }

  .twss_6310_team_style_01:hover img.twss_front_image {
    display: none !important;
  }

  .twss_6310_team_style_01_caption {
    padding: 0 15px;
    float: left;
    width: 100%;
  }

  .twss_6310_team_style_01_title {
  ...
  .twss_6310_team_style_01_designation {
  ...
  .twss_6310_team_style_01_profile_details {
  ...
  .twss_6310_team_style_01_contact {
    padding: 0;
  ...
  div.twss_6310_team_style_01_contact div {
    text-shadow: 1px 1px 1px rgba(0, 0, 0, 0.1);
  ...
  div.twss_6310_team_style_01_contact div span {
  ...
  .twss_6310_team_style_01:hover .twss_6310_team_style_01_title {
    color: <?php echo $cssData['member_font_hover_color'] ?>;
  }

  .twss_6310_team_style_01:hover .twss_6310_team_style_01_designation {
    color: <?php echo $cssData['designation_font_hover_color'] ?>;
  }

  .twss_6310_team_style_01:hover .twss_6310_team_style_01_profile_details {
    color: <?php echo $cssData['details_font_hover_color'] ?>;
  }

  .twss_6310_team_style_01:hover div.twss_6310_team_style_01_contact div {
    color: <?php echo $cssData['contact_font_hover_color'] ?>;
  }

  div.twss_6310_team_style_01_social {
  ...
  div.twss_6310_team_style_01_social div {
    display: inline-block;
    margin: <?php echo  $cssData['icon_text_align'] == 'left' ? "0 4px 4px 0;" : "0 0 4px 4px;"; ?>;
    padding: 0px;
  }

  div.twss_6310_team_style_01_social div a {
    display: flex;
