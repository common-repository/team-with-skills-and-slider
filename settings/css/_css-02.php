<style type="text/css">
  ...
  .twss_6310_team_style_02_img img {
  ...
  .twss_6310_team_style_02:hover img.twss_hover_image {
    display: initial !important;
  }

  .twss_6310_team_style_02:hover img.twss_front_image {
    display: none !important;
  }

  .twss_6310_team_style_02_caption {
    padding: 0 10px;
    float: left;
    width: 100%;
  }

  .twss_6310_team_style_02_title {
  ...
  .twss_6310_team_style_02_designation {
  ...
  .twss_6310_team_style_02_profile_details {
  ...
  .twss_6310_team_style_02_contact {
    padding: 0;
  ...
  div.twss_6310_team_style_02_contact div {
    text-shadow: 1px 1px 1px rgba(0, 0, 0, 0.1);
  ...
  div.twss_6310_team_style_02_contact div span {
  ...
  .twss_6310_team_style_02:hover .twss_6310_team_style_02_title {
    color: <?php echo $cssData['member_font_hover_color'] ?>;
  }

  .twss_6310_team_style_02:hover .twss_6310_team_style_02_designation {
    color: <?php echo $cssData['designation_font_hover_color'] ?>;
  }

  .twss_6310_team_style_02:hover .twss_6310_team_style_02_profile_details {
    color: <?php echo $cssData['details_font_hover_color'] ?>;
  }

  .twss_6310_team_style_02:hover div.twss_6310_team_style_02_contact div {
    color: <?php echo $cssData['contact_font_hover_color'] ?>;
  }

  div.twss_6310_team_style_02_social {
  ...
  div.twss_6310_team_style_02_social div {
    display: inline-block;
    margin: <?php echo  $cssData['icon_text_align'] == "left" ? "0 4px 4px 0;" : "0 0 4px 4px;"; ?>;
    padding: 0;
  }

  div.twss_6310_team_style_02_social div a {
    display: flex;
  ...
  div.twss_6310_team_style_02_social div a i {
