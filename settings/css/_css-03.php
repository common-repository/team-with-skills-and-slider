<style type="text/css">
  ...
  .twss_6310_team_style_03_img img {
    width: 100%;
    height: auto;
    padding: 0;
    margin: 0;
  ...
  .twss_6310_team_style_03:hover img.twss_hover_image {
    display: initial;
  }

  .twss_6310_team_style_03:hover img.twss_front_image {
    display: none;
  }

  .twss_6310_team_style_03_caption {
  ...
  .twss_6310_team_style_03_designation {
    font-size: 14px;
    font-weight: 100;
    color: #989898;
    line-height: 20px;
  ...
  div.twss_6310_team_style_03_social {
  ...
  div.twss_6310_team_style_03_social div {
    display: inline-block;
    margin: <?php echo  $cssData['icon_text_align'] == "left" ? "0 4px 4px 0;" : "0 0 4px 4px;"; ?>;
    padding: 0;
  }

  div.twss_6310_team_style_03_social div a {
    display: flex;
  ...
  div.twss_6310_team_style_03_social div a i {
  ...
  .twss_6310_team_style_03:hover .twss_6310_team_style_03_title {
  ...
  .twss_6310_team_style_03:hover .twss_6310_team_style_03_designation {
    color: <?php echo $cssData['designation_font_hover_color'] ?>;
  }

  .twss_6310_team_style_03_profile_details {
  ...
  .twss_6310_team_style_03:hover .twss_6310_team_style_03_profile_details {
    color: <?php echo $cssData['details_font_hover_color'] ?>;
  }

  .twss_6310_team_style_03_contact {
    padding: 0;
  ...
  div.twss_6310_team_style_03_contact div {
    text-shadow: 1px 1px 1px rgba(0, 0, 0, 0.1);
  ...
  .twss_6310_team_style_03:hover div.twss_6310_team_style_03_contact div {
    color: <?php echo $cssData['contact_font_hover_color'] ?>;
  }


  div.twss_6310_team_style_03_contact div span {
  ...
  .twss_6310_team_style_03:hover div.twss_6310_team_style_03_contact div span {
