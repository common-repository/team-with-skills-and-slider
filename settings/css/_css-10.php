<style>
  ...
  .twss_6310_team_style_10_img:after {
    content: "";
    width: 100%;
    height: 100%;
  ...
  .twss_6310_team_style_10:hover .twss_6310_team_style_10_img:after {
    bottom: 0;
  }

  .twss_6310_team_style_10 img {
    width: 100%;
    height: auto;
  }

  div.twss_6310_team_style_10_social {
    padding: 0 0 18px 0;
    list-style: none;
    position: absolute;
    top: -200%;
  ...
  .twss_6310_team_style_10:hover div.twss_6310_team_style_10_social {
    top: 5px;
  }

  div.twss_6310_team_style_10_social div {
    display: block;
    margin: 5px 0px;
  }

  div.twss_6310_team_style_10_social div a {
    display: flex;
  ...
  .twss_6310_team_style_10:hover .twss_6310_team_style_10_title {
    color: <?php echo $cssData['member_font_hover_color'] ?>;
  }

  .twss_6310_team_style_10_title:before {
    content: "";
    width: 50px;
    height: 1px;
  ...
  .twss_6310_team_style_10_title:after {
    content: "";
    display: block;
    width: 7px;
    height: 7px;
  ...
  .twss_6310_team_style_10:hover .twss_6310_team_style_10_title:after
 {
    background-color: <?php echo $cssData['member_border_hover_color'] ?>;
  }

  .twss_6310_team_style_10:hover .twss_6310_team_style_10_title:before
 {
    width: 100px;
    background-color: <?php echo $cssData['member_border_hover_color'] ?>;
  }

  .twss_6310_team_style_10_designation {
  ...
  .twss_6310_team_style_10:hover .twss_6310_team_style_10_designation {
    color: <?php echo $cssData['designation_font_hover_color'] ?>;
  }

  .twss_6310_team_style_10:hover .twss_6310_team_style_10_designation:before {
    background-color: <?php echo $cssData['member_border_hover_color'] ?>;

  }

  div.twss_6310_team_style_10_contact {
  ...
  div.twss_6310_team_style_10_contact div {
  ...
  .twss_6310_team_style_10:hover div.twss_6310_team_style_10_contact div {
    color: <?php echo $cssData['contact_font_hover_color'] ?>;
  }

  div.twss_6310_team_style_10_contact div span {
  ...
  .twss_6310_team_style_10:hover div.twss_6310_team_style_10_contact div span {
    color: <?php echo $cssData['contact_label_font_hover_color'] ?>;
  }



  .twss_6310_team_style_10_profile_details {
  ...
  .twss_6310_team_style_10:hover .twss_6310_team_style_10_profile_details {
    color: <?php echo $cssData['details_font_hover_color'] ?>;
  }

  .twss_6310_team_style_10 .twss_6310_team_style_10_read_more {
    width: 95% !important;
    transform: translate(3%, 0%);
  }


  .twss_6310_member_skills_wrapper_10 {
    float: left;
    width: 95% !important;
    transform: translate(3%, 0%);
  ...
  .twss_6310_team_style_10_title,
  .twss_6310_team_style_10_designation,
  .twss_6310_team_style_10_designation:before,
  .twss_6310_team_style_10_profile_details,

  ul.twss_6310_team_style_10_contact li,
  .twss_6310_team_style_10,
  .twss_6310_team_style_10_caption {
