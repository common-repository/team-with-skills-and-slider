<style type="text/css">
  ...
  .twss_6310_team_style_12 img {
    width: 100%;
    height: auto;
    float: left;
  }

  .twss_6310_team_style_12_img {
    position: relative;
    text-align: center;
    float: left;
    width: 100%;
  ...
  .twss_6310_team_style_12_social_team {
    position: absolute;
    bottom: 0;
    width: 100%;
    opacity: 0;
  ...
  .twss_6310_team_style_12:hover .twss_6310_team_style_12_social_team {
    opacity: 1;
  }
  ...
  .twss_6310_team_style_12:hover img.twss_hover_image {
    display: initial !important;
  }

  .twss_6310_team_style_12:hover img.twss_front_image {
    display: none !important;
  }

  .twss_6310_team_style_12_caption {
    padding: 0 10px;
    float: left;
    width: 100%;
  }

  .twss_6310_team_style_12_title {
  ...
  .twss_6310_team_style_12_designation {
  ...
  .twss_6310_team_style_12:hover .twss_6310_team_style_12_designation {
    color: <?php echo $cssData['designation_font_hover_color'] ?>;
  }

  .twss_6310_team_style_12_designation:after {
    content: "\00A0";
    width: 40px;
    height: 3px;
    margin: 2px auto 0;
  ...
  .twss_6310_team_style_12:hover .twss_6310_team_style_12_designation:after {
    background-color: <?php echo $cssData['designation_font_hover_color'] ?>;

  }

  .twss_6310_team_style_12_profile_details {
  ...
  .twss_6310_team_style_12_contact {
    padding: 0;
  ...
  div.twss_6310_team_style_12_contact div {
    text-shadow: 1px 1px 1px rgba(0, 0, 0, 0.1);
  ...
  .twss_6310_team_style_12:hover div.twss_6310_team_style_12_contact div {
    color: <?php echo $cssData['contact_font_hover_color'] ?>;
  }

  div.twss_6310_team_style_12_contact div span {
  ...
  .twss_6310_team_style_12:hover div.twss_6310_team_style_12_contact div span {
    color: <?php echo $cssData['contact_label_font_hover_color'] ?>;
  }

  .twss_6310_team_style_12:hover .twss_6310_team_style_12_title {
    color: <?php echo $cssData['member_font_hover_color'] ?>;
  }

  .twss_6310_team_style_12:hover .twss_6310_team_style_12_profile_details {
    color: <?php echo $cssData['details_font_hover_color'] ?>;
  }

  div.twss_6310_team_style_12_social {
  ...
  div.twss_6310_team_style_12_social div {
    display: inline-block;
    margin: 0 4px 8px;
    padding: 0;
  }

  div.twss_6310_team_style_12_social div a {
    display: flex;
  ...
  div.twss_6310_team_style_12_social div a i {
