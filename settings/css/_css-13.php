<style>
  ...
  .twss_6310_team_style_13:hover img.twss_hover_image {
    display: initial;
  }

  .twss_6310_team_style_13:hover img.twss_front_image {
    display: none;
  }

  .twss_6310_team_style_13_img {
    position: relative;
    text-align: center;
    float: left;
    width: 100%;
  ...
  .twss_6310_team_style_13 img {
    width: 100%;
    height: auto;
    float: left;
  }

  .twss_6310_team_style_13_title {
  ...
  .twss_6310_team_style_13:hover .twss_6310_team_style_13_title {
    color: <?php echo $cssData['member_font_hover_color'] ?>;
  }


  .twss_6310_team_style_13_designation {
  ...
  .twss_6310_team_style_13_caption {
    color: #013627;
    text-align: center;
    position: relative;
    overflow: hidden;
  ...
  .twss_6310_team_style_13:hover .twss_6310_team_style_13_caption,
  .twss_6310_team_style_13:hover .twss_6310_team_style_13_designation {
    color: <?php echo $cssData['designation_font_hover_color'] ?>;
  }


  div.twss_6310_team_style_13_social {
    list-style: none;
    top: -12px;
    position: absolute;
    padding: 0px 10px;
  ...
  .twss_6310_team_style_13:hover div.twss_6310_team_style_13_social {
    transform: translate(0px, 0px) rotateY(0deg);
  }

  div.twss_6310_team_style_13_social div {
    display: block;
    margin: 15px 0px;
  }

  div.twss_6310_team_style_13_social div a {
    display: flex;
  ...
  div.twss_6310_team_style_13_social div a i {
    line-height: <?php echo $cssData['social_line_height'] - ($cssData['social_border_width'] * 2) ?>px;
    font-size: <?php echo ceil(($cssData['social_icon_width'] + $cssData['social_icon_height']) / 4) ?>px;
  }

  .twss_6310_team_style_13_team_content {
    padding: 20px;
  }


  .twss_6310_team_style_13_profile_details {
  ...
  .twss_6310_team_style_13:hover .twss_6310_team_style_13_profile_details {
    color: <?php echo $cssData['details_font_hover_color'] ?>;
  }


  .twss_6310_team_style_13_contact {
    padding: 0;
    width: 95% !important;
    transform: translate(3%, 0%) !important;
    float: left !important;
  ...
  div.twss_6310_team_style_13_contact div {
  ...
  .twss_6310_team_style_13:hover div.twss_6310_team_style_13_contact div {
    color: <?php echo $cssData['contact_font_hover_color'] ?>;
  }

  div.twss_6310_team_style_13_contact div span {
  ...
  .twss_6310_team_style_13:hover div.twss_6310_team_style_13_contact div span {
    color: <?php echo $cssData['contact_label_font_hover_color'] ?>;
  }

  .twss_6310_member_skills_wrapper_13 {
    width: 95% !important;
    transform: translate(3%, 0%) !important;
    float: left !important;
  }

  .twss_6310_team_style_13_read_more {
    width: 95% !important;
    transform: translate(3%, 0%) !important;
  }
  ...
  .twss_6310_team_style_13_title,
  .twss_6310_team_style_13_designation,
  .twss_6310_team_style_13_designation:after,
  .twss_6310_team_style_13_profile_details,
  .twss_6310_team_style_13_contact,
  .twss_6310_team_style_13,
  .twss_6310_team_style_13_caption {
