              ...
              <tr  class="designation_act_field">
                ...
                <td>
                  <select name="designation_text_align" class="twss-form-input" id="twss_designation_text_align">
                    <option value="center" <?php if ($cssData['designation_text_align'] == 'center') echo " selected=''" ?>>Center</option>
          ...
          <div class="twss-col-6">
            <table class="table table-responsive twss_6310_admin_table">
              ...
              <tr class="social_act_field">
                ...
                <td>
                  <select name="social_icon_number" class="twss-form-input" id="social_icon_number">
                    <?php
                     for ($i = 1; $i <= 9; $i++) {
                      $items = $i == 1 ? ' item':' items';
                      if (!isset($cssData['social_icon_number']) && $i == 4) {
                        echo "<option selected value='{$i}'>{$i}{$items}</option>";
                      }
                      else if (isset($cssData['social_icon_number']) && $cssData['social_icon_number'] == $i) {
                        echo "<option selected value='{$i}'>{$i}{$items}</option>";
                      }
                      else {
