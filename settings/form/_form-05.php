          ...
          <div class="twss-col-6">
            ...
            <tr>
              ...
              <tr>
                ...
                <td>
                  <input type="text" name="image_border_color" id="twss_image_border_color" class="twss-form-input twss_6310_color_picker" data-format="rgb" data-opacity=".8" value="<?php echo $cssData['image_border_color'] ?>">
                </td>
              </tr>
              <tr>
                <td><b>Image Border Hover Color</b></td>
                <td>
                  <input type="text" name="image_border_hover_color" id="twss_image_border_hover_color" class="twss-form-input twss_6310_color_picker" data-format="rgb" data-opacity=".8" value="<?php echo $cssData['image_border_hover_color'] ?>">
                </td>
              </tr>
            </table>
          </div>
          <div class="twss-col-6">
            ...
            <tr>
              ...
              <tr>
                ...
                <td>
                  <input type="number" min="0" name="image_border_width" value="<?php echo $cssData['image_border_width'] ?>" class="twss-form-input" id="twss_image_border_width" />
                </td>
        ...
        <div class="row">
          ...
          <div class="twss-col-6">
            <table class="table table-responsive twss_6310_admin_table">
              ...
              <tr>
                <td><b>Title Background</b></td>
                <td>
                  <input type="text" name="member_title_background_color" id="twss_member_title_background_color" class="twss-form-input twss_6310_color_picker" data-format="rgb" value="<?php echo $cssData['member_title_background_color'] ?>" data-opacity=".8">
                </td>
              </tr>
              <tr>
                <td><b>Title Background hover</b></td>
                <td>
                  <input type="text" name="member_title_background_hover_color" id="twss_member_title_background_hover_color" class="twss-form-input twss_6310_color_picker" data-format="rgb" value="<?php echo $cssData['member_title_background_hover_color'] ?>" data-opacity=".8">
                </td>
              </tr>
              <tr>
          ...
          <div class="twss-col-6">
            <table class="table table-responsive twss_6310_admin_table">
              ...
              <tr>
                <td><b>Title Align</b></td>
                <td>
                  <select name="member_text_align" class="twss-form-input" id="twss_member_text_align">
                    <option value="left" <?php if ($cssData['member_text_align'] == 'left') echo " selected=''" ?>>Left</option>
                    <option value="right" <?php if ($cssData['member_text_align'] == 'right') echo " selected=''" ?>>Right</option>
                  </select>
                </td>
              </tr>
              <tr>
                ...
                <td>
                  <input name="member_title_padding" id="twss_member_title_padding" type="number" value="<?php echo $cssData['member_title_padding'] ?>" class="twss-form-input" />
                </td>
              </tr>
              <tr>
        ...
        <div class="row">
          ...
          <div class="twss-col-6">
            <table class="table table-responsive twss_6310_admin_table">
              ...
              <tr  class="designation_act_field">
                <td><b>Designation Background</b></td>
                <td>
                  <input type="text" name="member_designation_background_color" id="twss_member_designation_background_color" class="twss-form-input twss_6310_color_picker" data-format="rgb" data-opacity=".8" value="<?php echo $cssData['member_designation_background_color'] ?>">
                </td>
              </tr>
              <tr  class="designation_act_field">
                <td><b>Designation Background hover</b></td>
                <td>
                  <input type="text" name="member_designation_hover_background_color" id="twss_member_designation_background_hover_color" class="twss-form-input twss_6310_color_picker" data-format="rgb" value="<?php echo $cssData['member_designation_hover_background_color'] ?>" data-opacity=".8">
                </td>
              </tr>
              <tr  class="designation_act_field">
                <td><b>Font Weight</b></td>
          ...
          <div class="twss-col-6">
            <table class="table table-responsive twss_6310_admin_table">
              ...
              <tr  class="designation_act_field">
                <td><b>Designation Align</b></td>
                <td>
                  <select name="designation_text_align" class="twss-form-input" id="twss_designation_text_align">
                    <option value="left" <?php if ($cssData['designation_text_align'] == 'left') echo " selected=''" ?>>Left</option>
                    <option value="right" <?php if ($cssData['designation_text_align'] == 'right') echo " selected=''" ?>>Right</option>
                  </select>
                </td>
              </tr>
              <tr  class="designation_act_field">
                <td><b>Designation padding</b></td>
                <td>
                  <input name="designation_text_padding" id="twss_designation_text_padding" type="number" value="<?php echo $cssData['designation_text_padding'] ?>" class="twss-form-input" />
                </td>
              </tr>
