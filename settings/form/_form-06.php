          ...
          <div class="twss-col-6">
            <table class="table table-responsive twss_6310_admin_table">
              ...
              <tr>
                ...
                <td>
                  <input type="text" name="member_title_background_color" id="twss_member_title_background_color" class="twss-form-input twss_6310_color_picker" data-format="rgb" value="<?php echo $cssData['member_title_background_color'] ?>">
                </td>
              </tr>
              <tr>
                <td><b>Title Background hover</b></td>
                <td>
                  <input type="text" name="member_title_background_hover_color" id="twss_member_title_background_hover_color" class="twss-form-input twss_6310_color_picker" data-format="rgb" value="<?php echo $cssData['member_title_background_hover_color'] ?>">
                </td>
              </tr>
              <tr>
          ...
          <div class="twss-col-6">
            <table class="table table-responsive twss_6310_admin_table">
              ...
              <tr  class="designation_act_field">
                ...
                <td>
                  <input type="text" name="member_designation_background_color" id="twss_member_designation_background_color" class="twss-form-input twss_6310_color_picker" data-format="rgb" value="<?php echo $cssData['member_designation_background_color'] ?>">
                </td>
              </tr>
              <tr  class="designation_act_field">
                <td><b>Designation Background hover</b></td>
                <td>
                  <input type="text" name="member_designation_hover_background_color" id="twss_member_designation_background_hover_color" class="twss-form-input twss_6310_color_picker" data-format="rgb" value="<?php echo $cssData['member_designation_hover_background_color'] ?>">
                </td>
              </tr>
              <tr  class="designation_act_field">
                <td><b>Font Weight</b></td>
