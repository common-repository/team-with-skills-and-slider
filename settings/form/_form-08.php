        ...
        <div class="row twss_6310_padding_15_px">
          ...
          <div class="twss-col-6">
            <table class="table table-responsive twss_6310_admin_table">
              ...
              <tr>
                <td width="55%"><b>Image Hover Color</b></td>
                <td>
                  <input type="text" name="image_hover_color" id="twss_image_hover_color" class="twss-form-input twss_6310_color_picker" data-opacity=".8" data-format="rgb" value="<?php echo $cssData['image_hover_color'] ?>">
                </td>
              </tr>
              <tr>
                <td width="55%"><b>Image Hover Border Color</b></td>
                <td>
                  <input type="text" name="image_hover_border_color" id="twss_image_hover_border_color" class="twss-form-input twss_6310_color_picker" data-opacity=".8" data-format="rgb" value="<?php echo $cssData['image_hover_border_color'] ?>">
                </td>
              </tr>
              <tr>
                <td width="55%"><b>Image Hover Border thikness</b></td>
                <td>
                  <input type="number" name="image_hover_border_thikness" id="twss_image_hover_border_thikness" class="twss-form-input" value="<?php echo $cssData['image_hover_border_thikness'] ?>">
                </td>
              </tr>
              <tr>
