          ...
          <div class="twss-col-6">
            <table class="table table-responsive twss_6310_admin_table">
              ...
              <tr>
                ...
                <td>
                  <input type="text" name="member_border_color" id="twss_member_border_color" class="twss-form-input twss_6310_color_picker" data-format="rgb" value="<?php echo $cssData['member_border_color'] ?>">
                </td>
              </tr>
              <tr>
                <td><b>Border Hover Color</b></td>
                <td>
                  <input name="member_border_hover_color" id="twss_member_border_hover_color" type="text" data-format="rgb" value="<?php echo $cssData['member_border_hover_color'] ?>" class="twss-form-input twss_6310_color_picker" />
                </td>
              </tr>
          ...
          <div class="twss-col-6">
            <table class="table table-responsive twss_6310_admin_table">
              ...
              <tr class="social_act_field">
                <td width="55%"><b>Social Icon Border</b></td>
                <td>
