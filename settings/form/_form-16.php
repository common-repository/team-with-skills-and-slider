        ...
        <div class="row twss_6310_padding_15_px">
          ...
          <div class="twss-col-6">
            ...
            <tr>
              ...
              <tr>
                <td><b>Box Corner Background</b></td>
                <td>
              ...
              <tr>
                <td><b>Box Main Background</b></td>
                <td>
                  <input type="text" name="box_middle_background_color" id="twss_box_middle_background_color" class="twss-form-input twss_6310_color_picker" data-format="rgb" data-opacity=".8" value="<?php echo $cssData['box_middle_background_color'] ?>">
                </td>
              </tr>
              <tr>
                <td><b>Box Main Hover Background</b></td>
                <td>
                  <input type="text" name="box_middle_hover_background_color" id="twss_box_middle_hover_background_color" class="twss-form-input twss_6310_color_picker" data-format="rgb" data-opacity=".8" value="<?php echo $cssData['box_middle_hover_background_color'] ?>">
                </td>
              </tr>
            </table>
          </div>
          <div class="twss-col-6">
            <table class="table table-responsive twss_6310_admin_table">
              <tr>
                <td width="55%"><b>Box Hover Corner Background</b></td>
                <td>
              ...
              <tr>
                ...
                <td>
                  <select name="member_text_align" class="twss-form-input" id="twss_member_text_align">
                    <option value="flex-start" <?php if ($cssData['member_text_align'] == 'flex-start') echo " selected=''" ?>>Left</option>
                    <option value="center" <?php if ($cssData['member_text_align'] == 'center') echo " selected=''" ?>>Center</option>
                    <option value="flex-end" <?php if ($cssData['member_text_align'] == 'flex-end') echo " selected=''" ?>>Right</option>
                  </select>
                </td>
              </tr>
