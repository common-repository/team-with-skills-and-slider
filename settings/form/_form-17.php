      ...
      <div id="tab-1">
        <div class="row twss_6310_padding_15_px">
          ...
          <div class="twss-col-6">
            <table class="table table-responsive twss_6310_admin_table">
              <tr>
                <td><b>Box Gradiant Start</b></td>
                <td>
                  <input type="text" name="box_gradient_start_color" id="twss_box_gradient_start_color" class="twss-form-input twss_6310_color_picker" data-format="rgb" data-opacity=".8" value="<?php echo $cssData['box_gradient_start_color'] ?>">
                </td>
              </tr>
              <tr>
                <td><b>Box Gradian End</b></td>
                <td>
                  <input type="text" name="box_gradient_end_color" id="twss_box_gradient_end_color" class="twss-form-input twss_6310_color_picker" data-format="rgb" data-opacity=".8" value="<?php echo $cssData['box_gradient_end_color'] ?>">
                </td>
              </tr>
              <tr>
                <td><b>Box Gradiant Start Hover Color</b></td>
                <td>
                  <input type="text" name="box_gradient_start_hover_color" id="twss_box_gradient_start_hover_color" class="twss-form-input twss_6310_color_picker" data-format="rgb" data-opacity=".8" value="<?php echo $cssData['box_gradient_start_hover_color'] ?>">
                </td>
              </tr>
              <tr>
                <td><b>Box Gradian End Hover Color</b></td>
                <td>
                  <input type="text" name="box_gradient_end_hover_color" id="twss_box_gradient_end_hover_color" class="twss-form-input twss_6310_color_picker" data-format="rgb" data-opacity=".8" value="<?php echo $cssData['box_gradient_end_hover_color'] ?>">
                </td>
              </tr>
              <tr>
