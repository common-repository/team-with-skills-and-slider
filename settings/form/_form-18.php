        ...
        <div class="row twss_6310_padding_15_px">
          ...
          <div class="twss-col-6">
            ...
            <tr>
              ...
              <tr>
                <td><b>Box Background First Bottom </b></td>
                <td>
              ...
              <tr>
                <td><b>Box Background Second Bottom </b></td>
                <td>
              ...
              <tr>
                <td><b>Box Background Third Bottom </b></td>
                <td>
              ...
              <tr>
                <td><b>Box Background Fourth Bottom </b></td>
                <td>
              ...
              <tr>
                <td><b>Box Background Fifth Bottom </b></td>
                <td>
              ...
              <tr>
                <td><b>Box Background Sixth Bottom </b></td>
                <td>
              ...
              <tr>
                ...
                <td>
                  <input type="number" min="0" name="box_border_width" value="<?php echo $cssData['box_border_width'] ?>" class="twss-form-input" step="1" id="twss_box_border_width" />
                </td>
              </tr>
              <tr>
                <td width="55%"><b>Box Border Color</b></td>
                <td>
                  <input type="text" name="box_border_color" id="twss_box_border_color" class="twss-form-input twss_6310_color_picker" data-opacity=".8" data-format="rgb" value="<?php echo $cssData['box_border_color'] ?>">
                </td>
              </tr>
            </table>
          </div>
          <div class="twss-col-6">
            <table class="table table-responsive twss_6310_admin_table">
              <tr>
                ...
                <td>
                  <input type="text" name="box_border_hover_color" id="twss_box_border_hover_color" class="twss-form-input twss_6310_color_picker" data-opacity=".8" data-format="rgb" value="<?php echo $cssData['box_border_hover_color'] ?>">
                </td>
              </tr>
              <tr>
                <td width="55%"><b>1st Box Background Top</b></td>
                <td>
              ...
              <tr>
                <td width="55%"><b>2nd Box Background Top</b></td>
                <td>
              ...
              <tr>
                <td width="55%"><b>3rd Box Background Top</b></td>
                <td>
              ...
              <tr>
                <td width="55%"><b>4th Box Background Top</b></td>
                <td>
              ...
              <tr>
                <td width="55%"><b>5th Box Background Top</b></td>
                <td>
              ...
              <tr>
                <td width="55%"><b>6th Box Background Top</b></td>
                <td>
        ...
        <div class="row">
          ...
          <div class="twss-col-6">
            <table class="table table-responsive twss_6310_admin_table">
              ...
              <tr>
                <td><b>Font Background Color</b></td>
                <td>
                  <input type="text" name="member_font_bg_color" id="twss_member_font_bg_color" class="twss-form-input twss_6310_color_picker" data-format="rgb" value="<?php echo $cssData['member_font_bg_color'] ?>">
                </td>
              </tr>
              <tr>
