        ...
        <div class="row twss_6310_padding_15_px">
          ...
          <div class="twss-col-6">
            ...
            <tr>
              ...
              <tr>
                <td><b>1st Box Background</b>
                  <div style="color: #727272; font-size: 11px">For each row</div>
                </td>
                <td>
                  <input type="text" name="box_background_first_color" id="twss_box_background_first_color" class="twss-form-input twss_6310_color_picker" data-format="rgb" data-opacity=".8" value="<?php echo $cssData['box_background_first_color'] ?>">
                </td>
              </tr>
              <tr>
                <td><b>2nd Box Background</b>
                  <div style="color: #727272; font-size: 11px">For each row</div>
                </td>
                <td>
                  <input type="text" name="box_background_second_color" id="twss_box_background_second_color" class="twss-form-input twss_6310_color_picker" data-format="rgb" data-opacity=".8" value="<?php echo $cssData['box_background_second_color'] ?>">
                </td>
              </tr>
              <tr>
                <td><b>3rd Box Background</b>
                  <div style="color: #727272; font-size: 11px">For each row</div>
                </td>
                <td>
                  <input type="text" name="box_background_third_color" id="twss_box_background_third_color" class="twss-form-input twss_6310_color_picker" data-format="rgb" data-opacity=".8" value="<?php echo $cssData['box_background_third_color'] ?>">
                </td>
              </tr>
              <tr>
                <td><b>4th Box Background</b>
                  <div style="color: #727272; font-size: 11px">For each row</div>
                </td>
                <td>
                  <input type="text" name="box_background_fourth_color" id="twss_box_background_fourth_color" class="twss-form-input twss_6310_color_picker" data-format="rgb" data-opacity=".8" value="<?php echo $cssData['box_background_fourth_color'] ?>">
                </td>
              </tr>
              <tr>
                <td><b>5th Box Background</b>
                  <div style="color: #727272; font-size: 11px">For each row</div>
                </td>
                <td>
                  <input type="text" name="box_background_five_color" id="twss_box_background_five_color" class="twss-form-input twss_6310_color_picker" data-format="rgb" data-opacity=".8" value="<?php echo $cssData['box_background_five_color'] ?>">
                </td>
              </tr>
              <tr>
                <td><b>6th Box Background</b>
                  <div style="color: #727272; font-size: 11px">For each row</div>
                </td>
                <td>
                  <input type="text" name="box_background_six_color" id="twss_box_background_six_color" class="twss-form-input twss_6310_color_picker" data-format="rgb" data-opacity=".8" value="<?php echo $cssData['box_background_six_color'] ?>">
                </td>
              </tr>
              <tr height="45">
                <td>
              ...
              <tr>
                ...
                <td>
                  <input type="number" min="0" name="box_img_border_width" id="twss_box_img_border_width" value="<?php echo $cssData['box_img_border_width'] ?>" class="twss-form-input" id="twss_image_radius" />
                </td>
              </tr>
              <tr>
                <td><b>Image Border Corlor</b></td>
                <td>
                  <input type="text" name="box_img_background_color" id="twss_box_img_background_color" class="twss-form-input twss_6310_color_picker" data-format="rgb" data-opacity=".8" value="<?php echo $cssData['box_img_background_color'] ?>">
                </td>
              </tr>
            </table>
          </div>
          <div class="twss-col-6">
            <table class="table table-responsive twss_6310_admin_table">
              <tr>
                <td><b>Image Hover Border Corlor</b></td>
                <td>
                  <input type="text" name="box_img_hover_background_color" id="twss_box_img_hover_background_color" class="twss-form-input twss_6310_color_picker" data-format="rgb" data-opacity=".8" value="<?php echo $cssData['box_img_hover_background_color'] ?>">
                </td>
              </tr>
              <tr>
                <td width="55%"><b>1st Box Hover Background</b></td>
                <td>
                  <input type="text" name="box_background_first_hover_color" id="twss_box_background_first_hover_color" class="twss-form-input twss_6310_color_picker" data-opacity=".8" data-format="rgb" value="<?php echo $cssData['box_background_first_hover_color'] ?>">
                </td>

              </tr>
              <tr>
                <td width="55%"><b>2nd Box Hover Background</b></td>
                <td>
                  <input type="text" name="box_background_second_hover_color" id="twss_box_background_second_hover_color" class="twss-form-input twss_6310_color_picker" data-opacity=".8" data-format="rgb" value="<?php echo $cssData['box_background_second_hover_color'] ?>">
                </td>
              </tr>
              <tr>
                <td width="55%"><b>3rd Box Hover Background</b></td>
                <td>
                  <input type="text" name="box_background_third_hover_color" id="twss_box_background_third_hover_color" class="twss-form-input twss_6310_color_picker" data-opacity=".8" data-format="rgb" value="<?php echo $cssData['box_background_third_hover_color'] ?>">
                </td>
              </tr>
              <tr>
                <td width="55%"><b>4th Box Hover Background</b></td>
                <td>
                  <input type="text" name="box_background_fourth_hover_color" id="twss_box_background_fourth_hover_color" class="twss-form-input twss_6310_color_picker" data-opacity=".8" data-format="rgb" value="<?php echo $cssData['box_background_fourth_hover_color'] ?>">
                </td>
              </tr>
              <tr>
                <td width="55%"><b>5th Box Hover Background</b></td>
                <td>
                  <input type="text" name="box_background_five_hover_color" id="twss_box_background_five_hover_color" class="twss-form-input twss_6310_color_picker" data-opacity=".8" data-format="rgb" value="<?php echo $cssData['box_background_five_hover_color'] ?>">
                </td>
              </tr>
              <tr>
                <td width="55%"><b>6th Box Hover Background</b></td>
                <td>
                  <input type="text" name="box_background_six_hover_color" id="twss_box_background_six_hover_color" class="twss-form-input twss_6310_color_picker" data-opacity=".8" data-format="rgb" value="<?php echo $cssData['box_background_six_hover_color'] ?>">
                </td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td>
                  <input type="text" name="hover_box_shadow_color" id="twss_hover_box_shadow_color" class="twss-form-input twss_6310_color_picker" data-opacity=".8" data-format="rgb" value="<?php echo $cssData['hover_box_shadow_color'] ?>">
                </td>
              </tr>
          ...
          <div class="twss-col-6">
            <table class="table table-responsive twss_6310_admin_table">
              ...
              <tr>
                ...
                <td>
                  <input type="text" name="member_bg_color" id="twss_member_bg_color" class="twss-form-input twss_6310_color_picker" data-format="rgb" value="<?php echo $cssData['member_bg_color'] ?>" data-opacity=".8">
                </td>
              </tr>
            </table>
          </div>
          ...
          <div class="twss-col-6">
            <table class="table table-responsive twss_6310_admin_table">
              ...
              <tr  class="designation_act_field">
                <td><b>Background Color</b></td>
                <td>
                  <input type="text" name="designation_bg_color" id="twss_designation_bg_color" class="twss-form-input twss_6310_color_picker" data-format="rgb" value="<?php echo $cssData['designation_bg_color'] ?>" data-opacity=".8">
                </td>
              </tr>
            </table>
          </div>
      ...
      <div id="tab-5">
        <div class="row">
          ...
          <div class="twss-col-6">
            <table class="table table-responsive twss_6310_admin_table">
              <tr class="social_act_field">
                <td><b>Icon Align</b></td>
                <td>
                  <select name="icon_text_align" class="twss-form-input" id="twss_icon_text_align">
