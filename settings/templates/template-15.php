<div id="twss-6310-noslider-<?php echo $styleId ?>">
   ...
   ?>
         <div class="twss-6310-col-<?php echo $cssData['item_per_row'] ?>">
            ...
            <div class="twss_6310_team_style_15 twss_6310_image_hover_effect">
                  ...
                  <div class="twss_6310_team_style_15_content_group">
                     ...
                     foreach ($template_order as $td) {
                        if ($td == 'twss_fun_template_name') {
                           ...
                           twss_fun_template_designation($value['designation'], $cssData, $styleId, '15');
                        }
                     }
                     ?>
                  </div>
                     ...
                     <div class="twss_6310_team_style_15_team_social">
                        ...
                        foreach ($template_order as $td) {
                           if ($td == 'twss_fun_template_social') {
                              ...
                              twss_fun_template_skills($value['skills'], '15', $cssData, $value['id']);
                           }
                        }
...
<div id="twss-6310-slider-<?php echo $styleId ?>" class="twss-6310-owl-carousel">
   ...
   if ($members) {
      foreach ($members as $value) {
         if ($value['profile_details_type'] == 1) {
            $link_type = " class='twss_6310_team_style_15 twss_6310_team_member_info' link-id='{$value['id']}' link-url='" . twss_6310_validate_profile_url($value['profile_url']) . "' target='{$value['open_new_tab']}' team-id='0'";
         } else if ($value['profile_details_type'] == 2) {
            $link_type = " class='twss_6310_team_style_15 twss_6310_team_member_info' link-id='0' team-id='{$value['id']}'";
         } else {
            $link_type = " class='twss_6310_team_style_15' link-id='0' team-id='0'";
         }
   ?>
